...
exports.referralSignupWelcomeEmail = referralSignupWelcomeEmail;
exports.referralRewardEmail = referralRewardEmail;
/**
 * Welcome email for new user who signed up with referral code
 * New user gets: 8 initial credits + 10 referral bonus = 18 total
 */
function referralSignupWelcomeEmail(newUserName, referrerName) {
 ...
 */
function referralRewardEmail(referrerName, newUserName) {
